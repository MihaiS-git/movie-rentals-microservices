...
export class RentalInboxService {
  ...
  private initializeWebSocketConnection(): void {
    const serverUrl = environment.websocketUrls.rentalEntityApiUrl;
  ...
  private onConnected(frame: any): void {
    ...
    this.stompClient.subscribe('/topic/rentalmessage', (message: Message) => {
      try {
