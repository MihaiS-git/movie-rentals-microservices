...
export class MovieInboxService {
  ...
  private initializeWebSocketConnection(): void {
    const serverUrl = environment.websocketUrls.movieEntityApiUrl;
  ...
  private onConnected(frame: any): void {
    ...
    this.stompClient.subscribe('/topic/moviemessage', (message: Message) => {
      try {
