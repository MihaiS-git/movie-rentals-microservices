package ubb.movierentals.ClientEntity.config;
...
//    private String clientRoutingKey;
    ...
    public Queue rentalQueue() {
        return new Queue(rentalQueueName, NON_DURABLE, false, AUTODELETE);
    }

    @Bean
    public Queue movieQueue() {
        return new Queue(movieQueueName, NON_DURABLE, false, AUTODELETE);
    }
    ...
    public Binding rentalBinding(Queue rentalQueue, TopicExchange exchange) {
        return BindingBuilder.bind(rentalQueue).to(exchange).with(rentalRoutingKey);
    }

    @Bean
    public Binding movieBinding(Queue movieQueue, TopicExchange exchange) {
        return BindingBuilder.bind(movieQueue).to(exchange).with(movieRoutingKey);
    }
